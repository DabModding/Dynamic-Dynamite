...
import dabdaddy.dynamic_dynamite.entity.dynamite.LightningDynamiteProjectile;
import dabdaddy.dynamic_dynamite.item.DynamiteItem;
import net.minecraft.world.entity.player.Player;
import net.minecraft.world.level.Level;

public class LightningDynamiteItem extends DynamiteItem
{
    @Override
    ...
    {
        return new LightningDynamiteProjectile(_level, _player);
    }
}
